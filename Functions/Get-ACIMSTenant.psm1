function Get-ACIMSTenant {
  <#
  .SYNOPSIS
  Get Cisco ACI Multi-Site tenants.
  ...
  .OUTPUTS
  [PSObject] Cisco ACI Multi-Site tenants.
  ...
  #>
    ...
    begin {
        # Define variables
        $method = 'Get'
        $uri = "https://$MSOHost/api/v1/tenants"
    }
